...
class InputTyr2 extends StatefulWidget {
  var l2;
  InputTyr2({Key key, this.formKey,this.l2}) : super(key: key);
  GlobalKey formKey;
  @override
  State<InputTyr2> createState() => _InputTyr2State();
}

class _InputTyr2State extends State<InputTyr2> {
...
@override
  ...
  remplir() {
    _tyreIdController.text = widget.l2[1].toString();
    _tyreModelIdController.text = widget.l2[2].toString();
    _tyrePositionIdController.text = widget.l2[0].toString();
    _fittingHController.text = widget.l2[4].toString();
    _fittingKmController.text = widget.l2[5].toString();
    _fittingRtdController.text = widget.l2[6].toString();
    _fittingDateController.text = widget.l2[7].toString();
    _activeController.text = widget.l2[8].toString();
  }
  @override
