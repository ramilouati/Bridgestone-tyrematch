...
class InputTyr extends StatefulWidget {
...
var l4;
  ...
  InputTyr({Key key, this.formKey,this.l1}) : super(key: key);
  GlobalKey formKey;

  @override
  State<InputTyr> createState() => _InputTyrState();
}

class _InputTyrState extends State<InputTyr> {
...
@override
  void initState() {
   ...
   remplir() {
    _tyreIdController.text = widget.l1[1].toString();
    _tyreModelIdController.text = widget.l1[2].toString();
    _tyrePositionIdController.text = widget.l1[0].toString();
    _fittingHController.text = widget.l1[4].toString();
    _fittingKmController.text = widget.l1[5].toString();
    _fittingRtdController.text = widget.l1[6].toString();
    _fittingDateController.text = widget.l1[7].toString();
    _activeController.text = widget.l1[8].toString();
  }
  @override
